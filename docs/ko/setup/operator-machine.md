...
**시계도 이때 한 번 재 두세요.** WSL2 게스트의 시각 소스는 기기마다 다르고, 어느 쪽이냐에 따라
저널이 몇 달 남는 기기가 되기도 8분만 남는 기기가 되기도 합니다 — 모르고 지나가면 나중에
"어젯밤 tick이 뭘 했지"가 답이 안 나옵니다. 진단 세 줄과 판별법은 [`team-runbook.md` §4 "로그가
사라지거나 테스트가 이유 없이 깨질 때 — 시계"](../team-runbook.md)에 있습니다.
